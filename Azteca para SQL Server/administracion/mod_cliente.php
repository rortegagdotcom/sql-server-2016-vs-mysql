...
$sql = "UPDATE clientes SET usuario='$usuario', nombre='$nombre', apellidos='$apellidos', dni='$dni', email='$email', telefono='$telefono' WHERE id_cliente='$id_cliente'";
if (sqlsrv_query($conn, $sql)) {
    header('Location: modificar_clientes.php');
} else {
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo modificar el cliente</h3>
			<p><a href="modificar_clientes.php">Volver a intentarlo</a></p>
		</div>
