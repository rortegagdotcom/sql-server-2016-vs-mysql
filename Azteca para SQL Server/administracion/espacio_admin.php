...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Bienvenido ' .$_SESSION['nombre_admin']. ' ' .$_SESSION['apellidos_admin']. ' - Inmobilaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Bienvenido ' .$_SESSION['nombre_admin']. ' ' .$_SESSION['apellidos_admin']. '</h3>
		</div>
