...
// Recibimos lo datos del formulario
	...
	$sql = "INSERT INTO clientes (usuario, contrasena, nombre, apellidos, dni, email, telefono) VALUES ('$usuario', CONVERT(VARCHAR(50), HASHBYTES('MD5', '$contrasena'), 2), '$nombre', '$apellido $apellido2', '$dni', '$email', '$telefono')";/*Consulta SQL*/
	if (sqlsrv_query($conn, $sql)) {/*Si la consulta es realizada correctamente, registro los datos introducidos en la tabla clientes*/
		echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Cliente creado - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<div class="cuerpo">
			...
			<p><a href="crear_cliente.php">Crear otro cliente</a></p>
		</div>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="cuerpo">
			...
			<p><a href="crear_cliente.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<link rel="shortcut icon" href="../favicon.ico" type="image/ico" />
		<title>Crear cliente - Inmobilaria Azteca</title>
		<link rel="stylesheet" type="text/css" href="../css/azteca.css"></link>
