...
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_garajes WHERE imagen_garajes.garaje=garajes.id_garaje) AS 'imagen', id_garaje, descripcion, metros, planta, numero, direccion FROM garajes";/*Consulta SQL*/
$resultado = sqlsrv_query($conn, $sql, $params, $options); /*Hago la consultado y lo guardo en una variable*/
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Garajes - Inmobilaria Azteca</title>
...
if (sqlsrv_num_rows($resultado) > 0){
	...
	echo '<tr class="cabecera"><th>Imagen</th><th>Id Garaje</th><th>Descripcion</th><th>Metros</th><th>Direccion</th><th>Planta</th><th>Numero</th></tr>';
	do {
		echo '<tr ';
		if ($num_fila%2==0) {
			echo 'class="blanco"';
