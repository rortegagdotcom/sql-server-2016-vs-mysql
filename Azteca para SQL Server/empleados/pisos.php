...
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_pisos WHERE imagen_pisos.piso=pisos.id_piso) AS 'imagen', id_piso, descripcion, metros, planta, puerta, direccion FROM pisos";/*Consulta SQL*/
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Pisos - Inmobilaria Azteca</title>
...
if (sqlsrv_num_rows($resultado) > 0){
	...
	echo '<tr class="cabecera"><th>Imagen</th><th>Id Piso</th><th>Descripcion</th><th>Metros</th><th>Direccion</th><th>Planta</th><th>Puerta</th></tr>';
	do {
		echo '<tr ';
		if ($num_fila%2==0) {
			echo 'class="blanco"';
