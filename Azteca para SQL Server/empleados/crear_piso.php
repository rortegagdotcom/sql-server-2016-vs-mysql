...
// Recibimos lo datos del formulario
	...
	$planta=$_POST['planta'];
	$puerta=$_POST['puerta'];
	$sql = "INSERT INTO pisos (descripcion, metros, direccion, planta, puerta) VALUES ('$descripcion', '$metros', '$direccion', '$planta', '$puerta'); SELECT SCOPE_IDENTITY();";/*Consulta SQL*/
	$stmt = sqlsrv_query($conn, $sql);
	if ($stmt) { /*Si todo es correcto en la consulta, guardo los datos en la tabla pisos*/
		echo '
...
sqlsrv_fetch($stmt);
$_SESSION['id_piso']=sqlsrv_get_field($stmt, 0);/*Guardo el id del piso creado en una variable de sesion*/
