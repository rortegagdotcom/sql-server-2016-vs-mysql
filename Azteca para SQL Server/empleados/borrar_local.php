...
$num_fila=0;
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_locales WHERE imagen_locales.local=locales.id_local) AS 'imagen', id_local, descripcion, metros, servicio, direccion FROM locales";
