...
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_pisos WHERE imagen_pisos.piso=pisos.id_piso) AS 'imagen', id_piso, descripcion, metros, planta, puerta, direccion FROM pisos WHERE cliente IS NULL AND garaje IS NULL";
