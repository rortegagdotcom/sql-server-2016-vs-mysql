...
$sql = "SELECT (SELECT TOP 1 archivo from imagen_casas WHERE imagen_casas.casa=casas.id_casa) AS 'imagen', id_casa, descripcion, metros, direccion FROM casas";/*Consulta SQL*/
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Casas - Inmobilaria Azteca</title>
...
if (sqlsrv_num_rows($resultado) > 0){
	...
	echo '<tr class="cabecera"><th>Imagen</th><th>Id Casa</th><th>Descripcion</th><th>Metros</th><th>Direccion</th></tr>';
	do {
		echo '<tr ';
		if ($num_fila%2==0) {
			echo 'class="blanco"';
