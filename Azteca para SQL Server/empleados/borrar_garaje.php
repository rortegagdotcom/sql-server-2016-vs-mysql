...
$num_fila=0;
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_garajes WHERE imagen_garajes.garaje=garajes.id_garaje) AS 'imagen', id_garaje, descripcion, metros, planta, numero, direccion FROM garajes";
