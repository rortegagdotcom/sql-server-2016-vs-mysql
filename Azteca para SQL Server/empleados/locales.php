...
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_locales WHERE imagen_locales.local=locales.id_local) AS 'imagen', id_local, descripcion, metros, servicio, direccion FROM locales";/*Consulta SQL*/
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Locales - Inmobilaria Azteca</title>
...
if (sqlsrv_num_rows($resultado) > 0){
	...
	echo '<tr class="cabecera"><th>Imagen</th><th>Id Local</th><th>Descripcion</th><th>Metros</th><th>Direccion</th><th>Servicio</th></tr>';
	do {
		echo '<tr ';
		if ($num_fila%2==0) {
			echo 'class="blanco"';
