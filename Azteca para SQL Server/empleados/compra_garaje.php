...
if(isset($_POST['enviar'])) {/*Si han enviado el formulario*/
	$valor=$_POST['valor'];
	$sqlcompra="INSERT INTO compras_garajes (valor, fecha, edificio) VALUES ('$valor', CONVERT(VARCHAR(10), GETDATE(), 105), '$id_garaje')";/*Consulta SQL*/
	if (sqlsrv_query($conn, $sqlcompra)) { /*Si la consulta es realizada correctamente, guardo que el garaje esta en venta*/
		echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Garaje creado y en venta - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Garaje creado correctamente y en venta</h3>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="cuerpo">
			<h3>No se pudo poner en venta'.print_r(sqlsrv_errors()).'</h3>
			<p><a href="compra_garaje.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<link rel="shortcut icon" href="../favicon.ico" type="image/ico" />
		<title>Poner precio al garaje - Inmobilaria Azteca</title>
		<link rel="stylesheet" type="text/css" href="../css/azteca.css"></link>
