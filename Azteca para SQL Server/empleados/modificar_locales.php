...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_locales WHERE imagen_locales.local=locales.id_local) AS 'imagen', id_local, descripcion, metros, direccion, servicio FROM locales";
	$resultado = sqlsrv_query($conn, $sql, $params, $options);
	$num_fila=0;
echo '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
