...
if(isset($_POST['borrar'])) {
	$x=$_POST['borra'];
	foreach ($x as $value) {
		$sql = "DELETE FROM garajes WHERE id_garaje='$value'";
		if (sqlsrv_query($conn, $sql)) {
			header ("Location: borrar_garaje.php");
		} else {
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo borrar el/los garaje/s seleccionado/s</h3>
			<p><a href="borrar_garaje.php">Volver a intentarlo</a></p>
		</div>
