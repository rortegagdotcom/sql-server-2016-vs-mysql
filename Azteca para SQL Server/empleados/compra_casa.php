...
if(isset($_POST['enviar'])) { /*Si han enviado el formulario*/
	$valor=$_POST['valor'];
	$sqlcompra="INSERT INTO compras_casas (valor, fecha, edificio) VALUES ('$valor', CONVERT(VARCHAR(10), GETDATE(), 105), '$id_casa')";/*Consulta SQL*/
	if (sqlsrv_query($conn, $sqlcompra)) { /*Si la consulta es realizada correctamente, guardo que la casa esta en venta*/
		echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Casa creada y en venta - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Casa creada correctamente y en venta</h3>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="cuerpo">
			<h3>No se pudo poner en venta</h3>
			<p><a href="compra_casa.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<link rel="shortcut icon" href="../favicon.ico" type="image/ico" />
		<title>Poner precio a la casa - Inmobilaria Azteca</title>
		<link rel="stylesheet" type="text/css" href="../css/azteca.css"></link>
