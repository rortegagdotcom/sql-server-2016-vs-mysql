...
if(isset($_POST['enviar'])) { /*Si han enviado el formulario*/
	$valor=$_POST['valor'];
	$sqlcompra="INSERT INTO compras_locales (valor, fecha, edificio) VALUES ('$valor', GETDATE(), '$id_local')";/*Consulta SQL*/
	if (sqlsrv_query($conn, $sqlcompra)) { /*Si la consulta es realizada correctamente, guardo que el local esta en venta*/
		echo '
