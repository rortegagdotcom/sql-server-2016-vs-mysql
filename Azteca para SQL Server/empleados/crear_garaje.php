...
// Recibimos lo datos del formulario
	...
	$planta=$_POST['planta'];
	$numero=$_POST['numero'];
	$sql = "INSERT INTO garajes (descripcion, metros, direccion, planta, numero) VALUES ('$descripcion', '$metros', '$direccion', '$planta', '$numero'); SELECT SCOPE_IDENTITY();";/*Consulta SQL*/
	$stmt = sqlsrv_query($conn, $sql);
	if ($stmt) {/*Si todo es correcto en la consulta, guardo los datos en la tabla garajes*/
		echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Garaje creado - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<form method="post" enctype="multipart/form-data" action="subir_imagen_garaje.php">
			Imagen:<br />
...
sqlsrv_fetch($stmt);
$_SESSION['id_garaje']=sqlsrv_get_field($stmt, 0);/*Guardo el id del garaje creado en una variable de sesion*/
	} else { /*Si no, muestro un error al crear el garaje*/
		echo '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo crear el garaje</h3>
			<p><a href="crear_garaje.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		<link rel="shortcut icon" href="../favicon.ico" type="image/ico" />
		<title>Crear garaje - Inmobilaria Azteca</title>
		<link rel="stylesheet" type="text/css" href="../css/azteca.css"></link>
		<script type="text/javascript" src="../js/crear_garaje.js"></script>
	</head>
	<body>
		<div class="logo">
			<a href="espacio_empleado.php"><img src="../favicon.png" alt="Inmo.Azteca"></img></a>
		...
		<br />
		<div class="cuerpo">
			<h3>Crear nuevo garaje</h3>
			<form method="post" enctype="multipart/form-data" onsubmit="return crear_garaje();">
			Descripcion:<br />
