...
$sql = "SELECT (SELECT TOP 1 archivo FROM imagen_casas WHERE imagen_casas.casa=casas.id_casa) AS 'archivo', id_casa, descripcion, metros, direccion, (SELECT valor FROM compras_casas WHERE compras_casas.edificio=casas.id_casa) AS 'valor' FROM casas WHERE casas.cliente IS NULL AND (SELECT cliente FROM compras_casas WHERE compras_casas.edificio=casas.id_casa) IS NULL AND (SELECT edificio FROM compras_casas WHERE compras_casas.edificio=casas.id_casa) IS NOT NULL AND casas.garaje IS NULL";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Casas sin garaje en venta - Inmobilaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Casas sin garaje en venta</h3>';
