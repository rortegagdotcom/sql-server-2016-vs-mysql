...
// Recibimos lo datos del formulario
	...
	$sql = "INSERT INTO clientes (usuario, contrasena, nombre, apellidos, dni, email, telefono) VALUES ('$usuario', CONVERT(VARCHAR(50), HASHBYTES('MD5', '$contrasena'), 2), '$nombre', '$apellido $apellido2', '$dni', '$email', '$telefono')"; /*Sentencia SQL*/
	if (sqlsrv_query($conn, $sql)) { /*Si la consulta se realiza correctamente se registra los datos introducidos del cliente*/
		echo '
