...
if(isset($_POST['enviar'])) { /*Si han enviado el formulario*/
	$valor=$_POST['valor'];
	$sqlcompra="INSERT INTO compras_casas (valor, fecha, edificio) VALUES ('$valor', curdate(), '$id_casa')";/*Consulta SQL*/
	if (mysqli_query($conn, $sqlcompra)) { /*Si la consulta es realizada correctamente, guardo que la casa esta en venta*/
		echo '
