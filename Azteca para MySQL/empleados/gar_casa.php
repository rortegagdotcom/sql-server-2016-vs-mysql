...
if(isset($_POST['enviar'])) {
	$cuales=$_POST['casa'];
	$id_casa=$cuales[0];
	$sql = "UPDATE casas SET garaje='$id_garaje' WHERE id_casa='$id_casa'";/*Consulta SQL*/
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Garaje agregado a la casa correctamente - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Garaje agregado a la casa correctamente</h3>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo agregar el garaje a la casa</h3>
			<p><a href="agregar_garaje_casa.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
