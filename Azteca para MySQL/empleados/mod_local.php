...
$sql = "UPDATE locales SET id_local='$id_local', descripcion='$descripcion', metros='$metros', direccion='$direccion', servicio='$servicio' WHERE id_local='$id_local'";
if (mysqli_query($conn, $sql)) {
    header('Location: modificar_locales.php');
} else {
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo modificar el local</h3>
			<p><a href="modificar_locales.php">Volver a intentarlo</a></p>
		</div>
