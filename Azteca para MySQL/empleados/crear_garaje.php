...
// Recibimos lo datos del formulario
	...
	$planta=$_POST['planta'];
	$numero=$_POST['numero'];
	$sql = "INSERT INTO garajes (descripcion, metros, direccion, planta, numero) VALUES ('$descripcion', '$metros', '$direccion', '$planta', '$numero')";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) {/*Si todo es correcto en la consulta, guardo los datos en la tabla garajes*/
		echo '
...
';
$_SESSION['id_garaje']=mysqli_insert_id($conn);/*Guardo el id del garaje creado en una variable de sesion*/
