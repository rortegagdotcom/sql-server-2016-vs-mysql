...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$sql = "SELECT (SELECT archivo FROM imagen_garajes WHERE imagen_garajes.garaje=garajes.id_garaje LIMIT 1) AS 'imagen', id_garaje, descripcion, metros, direccion, planta, numero FROM garajes";
	$resultado = mysqli_query($conn, $sql);
	$num_fila=0;
echo '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
