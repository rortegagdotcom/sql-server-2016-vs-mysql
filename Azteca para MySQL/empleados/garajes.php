...
$sql = "SELECT (SELECT archivo FROM imagen_garajes WHERE imagen_garajes.garaje=garajes.id_garaje LIMIT 1) AS 'imagen', id_garaje, descripcion, metros, planta, numero, direccion FROM garajes";/*Consulta SQL*/
$resultado = mysqli_query($conn, $sql); /*Hago la consultado y lo guardo en una variable*/
