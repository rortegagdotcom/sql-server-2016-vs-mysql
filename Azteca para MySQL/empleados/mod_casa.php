...
$sql = "UPDATE casas SET id_casa='$id_casa', descripcion='$descripcion', metros='$metros', direccion='$direccion' WHERE id_casa='$id_casa'";
if (mysqli_query($conn, $sql)) {
    header('Location: modificar_casas.php');
} else {
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo modificar la casa</h3>
			<p><a href="modificar_casas.php">Volver a intentarlo</a></p>
		</div>
