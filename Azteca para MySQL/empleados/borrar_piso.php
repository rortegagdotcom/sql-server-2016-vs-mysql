...
$num_fila=0;
$sql = "SELECT (SELECT archivo FROM imagen_pisos WHERE imagen_pisos.piso=pisos.id_piso LIMIT 1) AS 'imagen', id_piso, descripcion, metros, planta, puerta, direccion FROM pisos";
