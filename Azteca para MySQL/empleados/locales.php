...
$sql = "SELECT (SELECT archivo FROM imagen_locales WHERE imagen_locales.local=locales.id_local LIMIT 1) AS 'imagen', id_local, descripcion, metros, servicio, direccion FROM locales";/*Consulta SQL*/
