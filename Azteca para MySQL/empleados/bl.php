...
if(isset($_POST['borrar'])) {
	$x=$_POST['borra'];
	foreach ($x as $value) {
		$sql = "DELETE FROM locales WHERE id_local='$value'";
		if (mysqli_query($conn, $sql)) {
			header ("Location: borrar_local.php");
		} else {
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo borrar el/los local/es seleccionado/s</h3>
			<p><a href="borrar_local.php">Volver a intentarlo</a></p>
		</div>
