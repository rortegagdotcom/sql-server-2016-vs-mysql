...
if(isset($_POST['borrar'])) {
	$x=$_POST['borra'];
	foreach ($x as $value) {
		$sql = "DELETE FROM casas WHERE id_casa='$value'";
		if (mysqli_query($conn, $sql)) {
			header ("Location: borrar_casa.php");
		} else {
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo borrar la/s casa/a seleccionada/s</h3>
			<p><a href="borrar_casa.php">Volver a intentarlo</a></p>
		</div>
