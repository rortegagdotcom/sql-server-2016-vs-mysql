...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Bienvenido ' .$_SESSION['nombre_empleado']. ' ' .$_SESSION['apellidos_empleado']. ' - Inmobilaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Bienvenido ' .$_SESSION['nombre_empleado']. ' ' .$_SESSION['apellidos_empleado']. '</h3>
		</div>
