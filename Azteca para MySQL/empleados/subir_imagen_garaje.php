...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    $carpetaDestino="../imagenes/garajes/";
        ...
        for($i=0;$i<count($_FILES["archivo"]["name"]);$i++)
        {
            ...
            if($_FILES["archivo"]["type"][$i]=="image/jpeg" || $_FILES["archivo"]["type"][$i]=="image/pjpeg" || $_FILES["archivo"]["type"][$i]=="image/png")
            {
                ...
                if(file_exists($carpetaDestino))
                {
					...
					$sql="INSERT INTO imagen_garajes(archivo, garaje) VALUES ('$imagensql', '$id_garaje')";
                    # movemos el archivo
...
echo '
			<a href="compra_garaje.php">En compra</a>
			<a href="alquiler_garaje.php">En alquiler</a>
			<p>¿O agregar el garaje a casa o piso?</p>
			<a href="agregar_garaje_casa.php">Agregar garaje para una casa</a>
			<a href="agregar_garaje_piso.php">Agregar garaje para un piso</a>
		</div>
