...
if(isset($_POST['enviar'])) { /*Si han enviado el formulario*/
	$valor=$_POST['valor'];
	$sqlcompra="INSERT INTO compras_pisos (valor, fecha, edificio) VALUES ('$valor', curdate(), '$id_piso')";/*Consulta SQL*/
	if (mysqli_query($conn, $sqlcompra)) { /*Si la consulta es realizada correctamente, guardo que el piso esta en venta*/
		echo '
