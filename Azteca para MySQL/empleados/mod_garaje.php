...
$planta=$_POST['planta'];
$numero=$_POST['numero'];
$sql = "UPDATE garajes SET id_garaje='$id_garaje', descripcion='$descripcion', metros='$metros', direccion='$direccion', planta='$planta', numero='$numero' WHERE id_garaje='$id_garaje'";
if (mysqli_query($conn, $sql)) {
    header('Location: modificar_garajes.php');
} else {
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo modificar el garaje</h3>
			<p><a href="modificar_garajes.php">Volver a intentarlo</a></p>
		</div>
