...
// Recibimos lo datos del formulario
	...
	$sql = "INSERT INTO casas (descripcion, metros, direccion) VALUES ('$descripcion', '$metros', '$direccion')";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) { /*Si todo es correcto en la consulta, guardo los datos en la tabla casas*/
		echo '
...
';
$_SESSION['id_casa']=mysqli_insert_id($conn);/*Guardo el id de la casa creada en una variable de sesion*/
