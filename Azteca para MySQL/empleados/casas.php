...
$sql = "SELECT (SELECT archivo from imagen_casas WHERE imagen_casas.casa=casas.id_casa LIMIT 1) AS 'imagen', id_casa, descripcion, metros, direccion FROM casas";/*Consulta SQL*/
