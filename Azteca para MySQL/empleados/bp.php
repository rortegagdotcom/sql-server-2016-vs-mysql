...
if(isset($_POST['borrar'])) {
	$x=$_POST['borra'];
	foreach ($x as $value) {
		$sql = "DELETE FROM pisos WHERE id_piso='$value'";
		if (mysqli_query($conn, $sql)) {
			header ("Location: borrar_piso.php");
		} else {
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo borrar el/los piso/s seleccionado/s</h3>
			<p><a href="borrar_piso.php">Volver a intentarlo</a></p>
		</div>
