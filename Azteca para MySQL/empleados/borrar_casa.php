...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Borrar casa - Inmobilaria Azteca</title>
...
if (mysqli_num_rows($resultado) > 0){
	echo "<form method='post' enctype='multipart/form-data' action='bc.php'>";
	echo '<table border="1">';
	$fila = mysqli_fetch_assoc($resultado);
	echo '<tr class="cabecera"><th>Imagen</th><th>Id Casa</th><th>Descripcion</th><th>Metros</th><th>Direccion</th><th><input type="submit" value="Borrar" id="borrar" name="borrar" class="botontabla"></input></th></tr>';
	do {
		echo '<tr ';
		if ($num_fila%2==0) {
			echo 'class="blanco"';
		...
		echo "<td><input type='checkbox' name='borra[]' value='$id_casa'</input></td>";
		echo '</tr>';
		$num_fila++;
