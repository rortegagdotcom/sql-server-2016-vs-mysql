...
// Recibimos lo datos del formulario
	...
	$sql = "INSERT INTO locales (descripcion, metros, direccion, servicio) VALUES ('$descripcion', '$metros', '$direccion', '$servicio')";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) {/*Si todo es correcto en la consulta, guardo los datos en la tabla locales*/
		echo '
...
';
$_SESSION['id_local']=mysqli_insert_id($conn);/*Guardo el id del local creado en una variable de sesion*/
