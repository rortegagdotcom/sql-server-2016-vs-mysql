...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	$sql = "SELECT (SELECT archivo FROM imagen_pisos WHERE imagen_pisos.piso=pisos.id_piso LIMIT 1) AS 'imagen', id_piso, descripcion, metros, direccion, planta, puerta FROM pisos";
	$resultado = mysqli_query($conn, $sql);
	$num_fila=0;
echo '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
