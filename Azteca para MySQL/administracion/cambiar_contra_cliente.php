...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="cuerpo">
			...
			<form method="post" enctype="multipart/form-data" action="pass_cli.php" onsubmit="return cambiar();">
			Usuario:<br />
';
if ($resultado->num_rows > 0) { /*Si hay rows en la consulta*/
	...
	echo '</select>
		<br /><br />
				...
				<input type="submit" value="Cambiar contraseña" name="enviar" id="enviar" class="boton">
			</form>
		</div>';
