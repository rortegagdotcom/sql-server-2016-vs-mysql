...
// Recibimos lo datos del formulario
	...
	$sql = "INSERT INTO clientes (usuario, contrasena, nombre, apellidos, dni, email, telefono) VALUES ('$usuario', md5('$contrasena'), '$nombre', '$apellido $apellido2', '$dni', '$email', '$telefono')";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) {/*Si la consulta es realizada correctamente, registro los datos introducidos en la tabla clientes*/
		echo '
