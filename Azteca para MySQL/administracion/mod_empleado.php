...
$sql = "UPDATE empleados SET id_empleado='$id_empleado', usuario='$usuario', nombre='$nombre', apellidos='$apellidos', dni='$dni', email='$email', telefono='$telefono' WHERE id_empleado='$id_empleado'";
