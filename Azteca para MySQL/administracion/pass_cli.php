...
// Recibimos lo datos del formulario
	...
	$sql = "UPDATE clientes SET contrasena=md5('$contrasena') WHERE usuario='$usuario'";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) {/*Hago la conuslta*/
		if (mysqli_affected_rows($conn) > 0) { /*Si se han actualizado rows con la consulta, muestro que se ha actualizado la contraseña*/
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="cuerpo">
			...
			<p><a href="cambiar_contra_cliente.php">Cambiar contraseña a otro cliente</a></p>
		</div>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo cambiar la contraseña al cliente</h3>
			<p><a href="cambiar_contra_cliente.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
