...
// Recibimos lo datos del formulario
	...
	$sql = "DELETE FROM clientes WHERE usuario='$usuario'";/*Consulta SQL*/
	if (mysqli_query($conn, $sql)) {/*Hago la conuslta*/
		if (mysqli_affected_rows($conn) > 0) { /*Si se han borrado rows con la consulta corectamente, muestro que se ha borrado el cliente seleccionado*/
			echo '
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Cliente borrado - Inmobiliaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Cliente borrado</h3>
			<p><a href="borrar_cliente.php">Borrar otro cliente</a></p>
		</div>
...
';
		} else { /*Si no, muestro que no se ha borrado el cliente seleccionado*/
			echo '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>No se pudo borrar el cliente</h3>
			<p><a href="borrar_cliente.php">Volver a intentarlo</a></p>
		</div>
		<div class="validacion">
			<a href="http://validator.w3.org/check?uri=referer">
				<img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Strict" height="31" width="88" />
