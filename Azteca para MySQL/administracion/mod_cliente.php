...
$sql = "UPDATE clientes SET id_cliente='$id_cliente', usuario='$usuario', nombre='$nombre', apellidos='$apellidos', dni='$dni', email='$email', telefono='$telefono' WHERE id_cliente='$id_cliente'";
