...
$sql = "SELECT (SELECT archivo FROM imagen_pisos WHERE imagen_pisos.piso=pisos.id_piso LIMIT 1) AS 'archivo', id_piso, descripcion, metros, direccion, planta, puerta FROM pisos WHERE pisos.cliente IS NULL AND (SELECT cliente FROM alquiler_pisos WHERE alquiler_pisos.edificio=pisos.id_piso) IS NULL AND (SELECT edificio FROM alquiler_pisos WHERE alquiler_pisos.edificio=pisos.id_piso) IS NOT NULL AND pisos.garaje IS NULL";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Pisos sin garaje en alquiler - Inmobilaria Azteca</title>
	...
	<body>
		...
		<br />
		<div class="cuerpo">
			<h3>Pisos sin garaje en alquiler</h3>';
